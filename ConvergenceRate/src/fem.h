...
typedef enum {FEM_FULL,FEM_BAND,FEM_ITER,UNDEFINED} femSolverType;
...
typedef struct {
    ...
    int *dirichlet;
    double *soluce;
    double (*sourceValue)(double x, double y);
    double dirichletValue;
    double errorInterpolationL2;
    double errorInterpolationH1;
    double errorSoluceL2;
    double errorSoluceH1;
} femDiffusionProblem;
...
femDiffusionProblem *femDiffusionCreate(femMesh *theMesh, femSolverType solverType, femRenumType renumType);
...
void                 femDiffusionSetSource(femDiffusionProblem *theProblem, double(*source)(double,double));
